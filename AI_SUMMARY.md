...
### Deep Learning Fundamentals (primary)
...
Practical focus on making models run efficiently: INT8 quantization (PTQ, QAT), mixed-precision training with BF16, depthwise-separable convolutions for mobile, and parameter reduction techniques. Understands the full pipeline from FP32 training to edge deployment.
